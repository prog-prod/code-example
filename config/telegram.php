    ...
    */
    'bots' => [
        'printopia_bot' => [
            ...
            'webhook_domain' => env('TELEGRAM_WEBHOOK_DOMAIN', env('APP_URL')),
            'commands' => [
                \App\Commands\PrintopiaBot\HelpCommand::class,
                \App\Commands\PrintopiaBot\StartCommand::class,
                \App\Commands\PrintopiaBot\BindChatWithAdminCommand::class,
                \App\Commands\PrintopiaBot\UnbindChatWithAdminCommand::class,
            ],
        ],
