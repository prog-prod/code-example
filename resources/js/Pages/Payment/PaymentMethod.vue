                ...
                <div class="col-md-8">
                    <div class="inner-wrapper border-box">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-group ml-3 row">
                                <div class="col-12">
                                    <ul class="list-inline mb-3">
                                        <li class="list-inline-item"><img
                                            src="{{asset('/images/card-1.jpg')}}"
                                            alt="card"></li>
                                        <li class="list-inline-item"><img
                                            src="{{asset('/images/card-2.jpg')}}"
                                            alt="card"></li>
                                        <li class="list-inline-item"><img
                                            src="{{asset('/images/card-3.jpg')}}"
                                            alt="card"></li>
                                        <li class="list-inline-item"><img
                                            src="{{asset('/images/card-4.jpg')}}"
                                            alt="card"></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    <label for="cardName">Name on Card</label>
                                    <input id="cardName" type="text" name="cardName" class="form-control">
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="nice-select form-control" tabindex="0"><span class="current">Year</span>
                                                <ul class="list">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="nice-select form-control" tabindex="0"><span class="current">Month</span>
                                                <ul class="list">
                                                    <li data-value="" class="option selected">Month</li>
                                                    <li data-value="jan" class="option">Jan</li>
                                                    <li data-value="feb" class="option">Feb</li>
                                                    <li data-value="mar" class="option">Mar</li>
                                                    <li data-value="apr" class="option">Apr</li>
                                                    <li data-value="may" class="option">May</li>
                                                    <li data-value="jun" class="option">Jun</li>
                                                    <li data-value="jul" class="option">Jul</li>
                                                    <li data-value="aug" class="option">Aug</li>
                                                    <li data-value="sep" class="option">Sep</li>
                                                    <li data-value="oct" class="option">Oct</li>
                                                    <li data-value="nov" class="option">Nov</li>
                                                    <li data-value="dec" class="option">Dec</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input id="cvc" type="text" name="cvc" class="form-control" placeholder="1234">
                                </div>
                            </div>
                        </div>
                        <!-- /shipping-information -->
                        ...
                        <div class="p-4 bg-gray d-flex justify-content-between">
                            <Link :href="route('checkout.index')" class="btn btn-dark">Back</Link>
                            <Link :href="route('checkout.review.index')" class="btn btn-primary">Continue</Link>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
