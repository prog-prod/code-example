                ...
                <div class="col-md-12">
                    <div class="post post-single">
                        <div class="post-thumb">
                            <img class="img-fluid w-100" src="{{asset('/images/blog-post-1.jpg')}}" alt="post-thumb">
                        </div>
                        ...
                        <div class="post-meta">
                            <ul>
                                ...
                                <li><i class="ti-tag"> <a href="{{route('blog-single')}}"></a></i><a href="{{route('blog-single')}}"> LIFESTYLE</a>,<a href="{{route('blog-single')}}"> TRAVEL</a>, <a href="{{route('blog-single')}}">FASHION</a>
                                </li>
                                <li>
                                    <a href="{{route('blog-single')}}"><i class="ti-comments"></i> 4 COMMENTS</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="post-comments">
                            ...
                            <ul class="media-list mb-5">
                                ...
                                <li class="media">
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('/images/member-1.jpg')}}" alt="" width="50" height="50">
                                    </a>
                                    <div class="media-body">
                                        ...
                                        <div class="media">
                                            <a href="#">
                                                <img class="img-fluid" src="{{asset('/images/member-2.jpg')}}" alt="" width="50" height="50">
                                            </a>
                                            <div class="media-body">
                                                <div class="comment-info">
                                                    <div class="comment-author">
                                ...
                                <li class="media">
                                    <a href="#">
                                        <img class="img-fluid" src="{{asset('/images/member-3.jpg')}}" alt="" width="50" height="50">
                                    </a>
                                    <div class="media-body">
                                        <div class="comment-info">
                                            <div class="comment-author">
