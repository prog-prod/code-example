                ...
                <div class="col-md-8">
                    <div class="inner-wrapper border-box">
                        ...
                        <div class="justify-content-between nav mb-5">
                            ...
                            <a href="{{route('payment')}}" class="text-center d-inline-block nav-item active">
                            ...
                            <div class="form-group ml-3 row">
                                <div class="col-12">
                                    <ul class="list-inline mb-3">
                                        <li class="list-inline-item"><img src="{{asset('/images/card-1.jpg')}}" alt="card"></li>
                                        <li class="list-inline-item"><img src="{{asset('/images/card-2.jpg')}}" alt="card"></li>
                                        <li class="list-inline-item"><img src="{{asset('/images/card-3.jpg')}}" alt="card"></li>
                                        <li class="list-inline-item"><img src="{{asset('/images/card-4.jpg')}}" alt="card"></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                        ...
                        <div class="p-4 bg-gray d-flex justify-content-between">
                            ...
                            <a href="{{route('review')}}" class="btn btn-primary">Continue</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
